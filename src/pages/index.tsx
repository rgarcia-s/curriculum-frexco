        ...
        <Main>
          <div>
            ...
            <p>
              ...
              entrando no Bootcamp GoStack da Rocketseat. Nesse bootcamp aprendi
              a criar uma aplicação do zero, desenvolvendo seu backend e
              frontend web e mobile, conexão com bancos de dados relacionais e
              não relacionais, testes e deploy.
            </p>
          </div>
          <div>
            <h2>Habilidades</h2>
          ...
          <div>
            ...
            <ul className="formation">
              ...
              <li>
                ...
                <span>Sistemas de informação - Previsão de conclusão 2021</span>
              </li>
            </ul>
          </div>
        </Main>
        <Experiences>
          ...
          <ul>
            ...
            <li>
              ...
              <p>
                Sistema de agendamento de gerenciamento de alunos para academias
                construído com Node.js, ReactJS e React Native
              </p>
            </li>
            <li>
              <strong>
              ...
              <p>
                Website para visualização de dados de filmes e séries construído
                com Next.js e conexão com api externa. (Em construção)
              </p>
            </li>
          </ul>
        </Experiences>
